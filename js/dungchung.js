...
function capNhat_ThongTin_CurrentUser() {
    ...
    if (u) {
        ...
        document.getElementsByClassName('member')[0]
            .getElementsByTagName('a')[0].childNodes[2].nodeValue = ' ' + u.ten + ' ' + u.ho;
	...
	<div class="header group">
        <div class="logo">
            <a href="index.html" style="display: block; width: 100%; height: 100%;">
                <img src="img/logo.png" alt="Trang chủ Headphone Store" title="Trang chủ Headphone Store">
            </a>
        </div> <!-- End Logo -->
            ...
            <div class="search-header">
                <form class="input-search" method="get" action="index.html">
                    <div class="autocomplete">
                        <input id="search-box" name="search" autocomplete="off" type="text" placeholder="Nhập sản phẩm tìm kiếm...">
                        <button type="submit">
            ...
            <div class="tools-member">
                <div class="member">
                    ...
                    <div class="menuMember hide">
                        <a href="nguoidung.html">Trang cá nhân</a>
...
function addFooter() {
    ...
    <!-- ============== Footer ============= -->
    <footer class="footer">
        <span>© 2021. Công ty cổ phần HeadPhone Store</span>
    </footer>
    `);
}
    ...
    <div class="plc">
        <section>
            <ul class="flexContain">
                <li>Giao hàng tiện lợi, siêu siêu nhanh</li>
                <li>Thanh toán linh hoạt: tiền mặt, thẻ ngân hàng, ví điện tử, trả góp</li>
                <li>Trải nghiệm sản phẩm tại cửa hàng</li>
                <li>Lỗi 1 đổi 1 ngay trong tháng đầu</li>
                <li>Hỗ trợ suốt thời gian sử dụng.
                    <br>Hotline:
                    <a href="tel:0123456789" style="color: #288ad6;">012.345.6789</a>
                </li>
            </ul>
        </section>
    </div>`);
