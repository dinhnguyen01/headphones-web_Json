...
window.onload = function () {
    ...
    adminInfo = adminInfo /*|| getListAdmin()*/;
...
function addThongKe() {
    ...
    type: 'bar',
    data: {
        labels: ['Apple', 'Ava', 'Awei', 'Beats', 'JBL', 'Logitech'],
        datasets: [{
...
function layThongTinSanPhamTuTable(id) {
    ...
    var info1 = tr[11].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var info2 = tr[12].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var info3 = tr[13].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var info4 = tr[14].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var info5 = tr[15].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var info6 = tr[16].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var info7 = tr[17].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var info8 = tr[18].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
    var info9 = tr[19].getElementsByTagName('td')[1].getElementsByTagName('input')[0].value;
...
function themSanPham() {
    ...
    for(var p of listProducts) {
     ...
     // Them san pham vao listProducts
     listProducts.push(newSp);
...
function autoMaSanPham(company) {
    ...
    var index = 0;
    for (var i = 0; i < listProducts.length; i++) {
        if (listProducts[i].company == company) {
            index++;
        }
    }
...
function addKhungSuaSanPham(masp) {
    ...
    var company = ["Apple", "Ava", "Awei", "Beats", "Belkin", "Jabra","JBL", "Kanen", "LG", "Logitech", "Oppo", "Rapoo","SamSung", "Sony", "Xiaomi"];
    ...
    s += `
        ...
        <tr>
            ...
            <td><input type="text" value="`+sp.detail.info1+`"></td>
        </tr>
        <tr>
            <td>Thời gian sử dụng hộp sạc:</td>
            <td><input type="text" value="`+sp.detail.info2+`"></td>
        </tr>
        <tr>
            <td>Cổng sạc:</td>
            <td><input type="text" value="`+sp.detail.info3+`"></td>
        </tr>
        <tr>
            <td>Công nghệ âm thanh:</td>
            <td><input type="text" value="`+sp.detail.info4+`"></td>
        </tr>
        <tr>
            <td>Tương thích:</td>
            <td><input type="text" value="`+sp.detail.info5+`"></td>
        </tr>
        <tr>
            <td>Tiện ích:</td>
            <td><input type="text" value="`+sp.detail.info6+`"></td>
        </tr>
        <tr>
            <td>Kết nối:</td>
            <td><input type="text" value="`+sp.detail.info7+`"></td>
        </tr>
        <tr>
            <td>Phím điều kiển:</td>
            <td><input type="text" value="`+sp.detail.info8+`"></td>
        </tr>
        <tr>
            <td>Sản xuất:</td>
            <td><input type="text" value="`+sp.detail.info9+`"></td>
        </tr>
        <tr>
...
function getListDonHang() {
    ...
    for(var i = 0; i < u.length; i++) {
        for(var j = 0; j < u[i].donhang.length; j++) {
            ...
            // console.log(u[i].donhang[j].ngaymua);
            ...
            for(var s of u[i].donhang[j].sp) {
                sps += `<p style="margin-bottom: 10px">`+(timKiemTheoMa(listProducts, s.ma).name + ' [' + s.soluong + ']') + `</p>`;
                
                if(s.soluong >= 2) {
                    var timsp = timKiemTheoMa(listProducts, s.ma);
                 
                    if(timsp.promo.name == 'giareonline') {
                        tongtien += stringToNum(timsp.promo.value)*s.soluong;
                    }
                    else { 
